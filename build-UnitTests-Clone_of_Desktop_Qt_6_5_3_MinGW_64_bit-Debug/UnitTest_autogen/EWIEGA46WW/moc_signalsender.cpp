...
Q_CONSTINIT static const qt_meta_stringdata_CLASSsignalsenderENDCLASS_t qt_meta_stringdata_CLASSsignalsenderENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(48, 17),  // "moveRequestSignal"
        QT_MOC_LITERAL(66, 12),  // "playerToMove"
        QT_MOC_LITERAL(79, 11),  // "destination"
        QT_MOC_LITERAL(91, 18)   // "StateRequestSignal"
    },
    "signalsender",
    "AddPlayerSignal",
    "",
...
void signalsender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->moveRequestSignal((*reinterpret_cast< std::add_pointer_t<Player*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 2: _t->StateRequestSignal(); break;
        default: ;
        }
        ...
        {
            using _t = void (signalsender::*)(Player * , int );
            if (_t _q_method = &signalsender::moveRequestSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (signalsender::*)();
            if (_t _q_method = &signalsender::StateRequestSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void signalsender::moveRequestSignal(Player * _t1, int _t2)
{
...
// SIGNAL 2
void signalsender::StateRequestSignal()
{
