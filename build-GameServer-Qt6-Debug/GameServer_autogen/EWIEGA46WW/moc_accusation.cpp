...
struct qt_meta_stringdata_Accusation_t {
    const uint offsetsAndSize[2];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Accusation_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Accusation_t qt_meta_stringdata_Accusation = {
    {
...
static const uint qt_meta_data_Accusation[] = {
...
const QMetaObject Accusation::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Accusation.offsetsAndSize,
    qt_meta_data_Accusation,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Accusation_t
...
void *Accusation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Accusation.stringdata0))
