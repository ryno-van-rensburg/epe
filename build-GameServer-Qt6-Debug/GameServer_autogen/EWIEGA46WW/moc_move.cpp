...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Move_t, stringdata0) + ofs), len 
...
const QMetaObject Move::staticMetaObject = { {
    ...
    qt_meta_stringdata_Move.offsetsAndSize,
    qt_meta_data_Move,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Move_t
