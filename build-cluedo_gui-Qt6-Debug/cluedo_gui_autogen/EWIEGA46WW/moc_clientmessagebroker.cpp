...
QT_MOC_LITERAL(857, 22) // "unpackShowCardToPlayer"
    ...
    "turnSignal\0cardsDealt\0cardShown\0hasCard\0"
    "asked\0showed\0cardShownToPlayer\0card\0"
...
void ClientMessageBroker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientMessageBroker::turnSignal)) {
                *result = 6;
                return;
            }
        }
